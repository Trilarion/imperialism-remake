...
class StructureTypeToPixmapMapper(TerrainToPixmapMapper):
    def __init__(self, server_scenario):
        super().__init__(server_scenario.get_structure_settings(), constants.GRAPHICS_STRUCTURE_FOLDER,
                         'texture_filename')
    ...
    def get_pixmap_of_type(self, structure_type: int):
        ...
        return self._get_pixmap_of_type(structure_type)
