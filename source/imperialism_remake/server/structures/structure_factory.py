...
from imperialism_remake.server.structures.structure_ranch import StructureRanch
...
class StructureFactory:
    ...
    def create_new_structure(server_scenario: ServerScenario, structure) -> Structure:
        ...
        elif structure.get_type() == StructureType.MINE:
            return StructureMine(server_scenario, structure)
        elif structure.get_type() == StructureType.RANCH:
            return StructureRanch(server_scenario, structure)
